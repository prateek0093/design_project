        ...
        <header className="w-full bg-white p-4">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <nav className="space-x-4">
              ...
              <Link to="/authorLogin" className="bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600">
                Author
              </Link>
              <Link to="/signup" className="text-blue-500 hover:text-blue-600">Student</Link>
            </nav>
          </div>
        </header>
          ...
          <div className="flex w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="w-1/2 p-8">
              <div className="flex items-center justify-center mb-6">
                <span className="text-2xl font-bold text-gray-700">Author Login</span>
              </div>
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="mb-6">
                  <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 border ${error.password ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  />
                  {error.password && (
